...
const ApplicationItem = ({
  ...
  return (
    <Spin spinning={loading}>
      <div   className={`flex flex-row items-center justify-between p-3.5 transition-colors hover:bg-[var(--primary-active)] border-b border-[var(--gap-text)] border-b-solid`}>
